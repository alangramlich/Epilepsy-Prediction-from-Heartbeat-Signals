...
nni_diff_mean = td.nni_differences_parameters(nni=intervalos_nn)['nni_diff_mean']
...
# Armar diccionario con todos los parámetros
parametros = {
    "nni_diff_mean": nni_diff_mean,
    "hr_mean": hr_mean,
    "hr_min": hr_min,
    "hr_max": hr_max,
    "hr_std": hr_std,
    ...
    "LF_power": lf_power,
    "HF_power": hf_power,
    "LF/HF_ratio": lfhf_ratio,
    "SD1": sd1,
    "SD2": sd2,
    "SD_ratio": sd_ratio,
    "Elipse_area": elipse_area,
    "SampEn": entropia,
    "CSI": CSI
}

# Convertir a DataFrame para imprimir en formato tabla
df = pd.DataFrame(list(parametros.items()), columns=["Parámetro", "Valor"])
